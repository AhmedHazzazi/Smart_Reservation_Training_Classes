...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:Panel ID="ViewsPanel" runat="server" CssClass="m-1">
            ...
            <div class="row p-2">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtUserName" runat="server" CssClass="form-control form-control-sm" autocomplete="off" placeholder="اسم المستخدم" />
                ...
                <div class="row">
                    <div class="col-sm-10">
                        <asp:Button ID="BtnSendPassword" runat="server" Text="إستعادة كلمة المرور" CssClass="btn btn-primary" OnClientClick="Loader()" OnClick="BtnSendPassword_Click" />
                    </div>
                </div>
            </div>
        </asp:Panel>
    ...
    <Triggers>
        <asp:AsyncPostBackTrigger ControlID="BtnSendPassword" EventName="Click" />
    </Triggers>
</asp:UpdatePanel>
</asp:Content>