                ...
                <div class="row p-2">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            ...
                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control form-control-sm" placeholder="الإسم الكامل" />
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <asp:TextBox ID="txtUserName" runat="server" CssClass="form-control form-control-sm" placeholder="اسم المستخدم" OnTextChanged="txtUserName_TextChanged" AutoPostBack="True" />
