        ...
        <asp:Panel ID="ViewsPanel" runat="server">
            ...
            <div class="row p-2">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <asp:Button ID="BtnRecoverUserName" runat="server" Text="إستعادة إسم المستخدم" CssClass="btn btn-primary" OnClientClick="Loader()" OnClick="BtnRecoverUserName_Click" />
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <asp:Label ID="lblSuccess" runat="server" CssClass="success fs-5" Visible="false"></asp:Label>
                        <%--<asp:TextBox ID="txtUserName" runat="server" CssClass="form-control form-control-sm" ReadOnly="true" />--%>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-10">
